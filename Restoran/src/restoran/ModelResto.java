...
class ModelResto {
    ...
    public ModelResto(){
     ...
     public void insertResto(String kode, String nama, String harga,String jenis){
      try{
          String query = "INSERT INTO `mvc_resto`(`kode`, `nama`, `harga`,`jenis`) VALUES ('"+kode+"','"+nama+"','"+harga+"','"+jenis+"')";
     ...
     public String[][] readResto(){ //dua dimensi (baris-kolom)
      ...
      try{
       ...
       public void deleteResto(String kode){ //menghapus data bds nim
        try{
            String query = "DELETE FROM `mvc_resto` WHERE `kode` = '"+kode+"'";
            statement = koneksi.createStatement();
  ...
  public void updateResto(String kode, String nama, String harga,String jenis){
      try{
          String query = "UPDATE `mvc_resto` SET `kode`='"+kode+"',`nama`='"+nama+"',`harga`='"+harga+"',`jenis`='"+jenis+"' WHERE `kode` = '"+kode+"'";
          //String '"+string+"', kalau int "+int+"
          statement = (Statement) koneksi.createStatement();
          statement.executeUpdate(query); //excecute query nya
